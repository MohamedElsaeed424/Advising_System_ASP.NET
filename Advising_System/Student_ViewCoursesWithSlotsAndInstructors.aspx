...
<head runat="server">
    <title>Courses With Corresponding Slots And Instructors</title>
    <style>
               body {
    ...
    border: 10px solid white; /* Thin white border */
        ...
        .back-button:hover {
            ...
            border: 2px solid  #4CAF50;
                ...
                #CoursesWithCorrespondingSlotsAndInstructors {
    margin-top: 20px;
    border-collapse: collapse;
    width: 100%;
}

#CoursesWithCorrespondingSlotsAndInstructors th,
#CoursesWithCorrespondingSlotsAndInstructors td {
    padding: 10px;
